...
<head>
    ...
    <title>Intrella - Manage Students</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end gradient-custom-2" id="sidebar-wrapper">
            ...
            <div class="list-group text-break list-group-flush shadow-none">
                ...
                <a class="list-group-item list-group-item-white list-group-item-action p-3 gradient-custom-2 shadow-none border-white active" href="manageusers.php"><i class="fa-solid fa-user-pen fa-lg mx-1"></i> Manage Students</a>
                    ...
                    <div class="col-md-10">
                        ...
                        <form action="deleteuser.php" method="post" id="deleteuserform"></form>
                                    ...
                                    <!-- Creating a hidden input field csrf -->
                                      <?=$csrf->input('deleteuserform','deleteuserform');?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="usertable">
                                ...
                                <tbody>
                                    <?php
                                    $query = "select * from tickets_2022_users";
                                        ...
                                        <tr class="align-middle text-center text-nowrap">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <button class="btn btn-danger btn-sm delete text-white shadow-none" id="butdel" name="butdel" form="deleteuserform" value="<?= $row["id"] ?>">
