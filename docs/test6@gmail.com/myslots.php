        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3 g-4">
                    ...
                    <?php
                    /* Selecting all the slots from the database where the user is the current user and the date is greater than the current date. */
                    $query = "select * from tickets_2022_slots where user = '" . $_SESSION["user"] . "'";
                            ...
                            <div class="card border-green shadow-none">
                                <div class="card-header gradient-custom-2 py-2">
                                    <div class="today text-capitalize d-flex align-items-center justify-content-between text-white">
                                        ...
                                        <div class="fs-6 bg-white text-green px-1-4 rounded-1">
                                            <?= $row["userstatus"] ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    if (($row["date"] == date("Y-m-d") && $row["starttime"] < date("H:i:s") && $row["userstatus"] != "closed")) {
                                    ...
                                    <form action="updateslot.php" method="POST" class="updateslotform">
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                ...
                                                <input type="hidden" name="employee" id="employee" value="<?= $row["employee"] ?>">
