...
<head>
    ...
    <title>Intrella - Employee Login</title>
                            ...
                            <div class="col-md-6">
                                <div class="card-body p-md-5 py-4 mx-md-4 mx-2">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-4 mb-4-2 text-decoration-underline tug-1">Employee Login</h4>
                                    </div>

                                    <!-- login form -->

                                    <form method="post" action="auth.php" id="employeeloginform">

                                    <!-- Creating a hidden input field csrf -->
                                      <?=$csrf->input('employeeloginform');?>
