    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end gradient-custom-2" id="sidebar-wrapper">
            ...
            <div class="list-group text-break list-group-flush shadow-none">
                ...
                <a class="list-group-item list-group-item-white list-group-item-action p-3 gradient-custom-2 shadow-none border-white active" href="viewslots.php"><i class="fa-solid fa-check-to-slot fa-lg mx-1"></i> All Slots</a>
